...
@if ($isGhlAttachment)
    <a href="{{ $downloadUrl }}" target="_blank" rel="noopener" class="chat-attachment-file text-decoration-none"
...
@elseif ($mime === 'application/pdf')
    <a href="{{ $downloadUrl }}" class="chat-attachment-file text-decoration-none"
        title="{{ $attachment['filename'] ?? 'attachment' }}">
