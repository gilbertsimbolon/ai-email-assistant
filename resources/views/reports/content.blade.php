    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white">
            <ul class="nav nav-tabs card-header-tabs" id="contentTabs" role="tablist">
                <li class="nav-item">
                    <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#tab-sops" data-tab-key="sops"
                        type="button">SOP</button>
                </li>
                <li class="nav-item">
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-knowledge" data-tab-key="knowledge"
                        type="button">Knowledge Base</button>
                </li>
                <li class="nav-item">
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-templates"
                        data-tab-key="reply-templates" type="button">Reply Template</button>
                </li>
                <li class="nav-item">
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-workflows" data-tab-key="workflows"
                ...
                <div class="btn-group btn-group-sm">
                    @foreach (['pdf' => ['PDF', 'danger'], 'excel' => ['Excel', 'success'], 'csv' => ['CSV', 'secondary']] as $format => $meta)
                        <a id="export-{{ $format }}"
                            ...
                            class="btn btn-outline-{{ $meta[1] }} js-export-link"
                            data-format="{{ $format }}">Export {{ $meta[0] }} (tab aktif)</a>
                    @endforeach
                </div>
            </div>
    ...
    <script>
        $(function() {
            ...
            function initTable(pane) {
                ...
                // Jangan inisialisasi kalau tabel tidak punya data
